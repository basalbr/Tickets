<?php include_once '../../../controle/central/home/index.php'; ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!-- Menu esquerdo -->
        <?php
        include_once '../../../controle/central/includes/menu_esquerdo.php';
        ?>
        <!-- Right side -->
        <div id="rightSide">
            ...
            <!-- Menu topo -->
            <?php
            include_once '../../../controle/central/includes/menu_topo.php';
            ?>
            <!-- Title area -->
            <div class="titleArea">
                <div class="wrapper">
