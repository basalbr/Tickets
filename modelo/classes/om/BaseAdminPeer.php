...
abstract class BaseAdminPeer {
	...
	const SENHA = 'admin.SENHA';

	/** the column name for the ATIVO field */
	const ATIVO = 'admin.ATIVO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Usuario', 'Senha', 'Ativo', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuario', 'senha', 'ativo', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USUARIO, self::SENHA, self::ATIVO, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO', 'SENHA', 'ATIVO', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'usuario', 'senha', 'ativo', 'email', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Usuario' => 1, 'Senha' => 2, 'Ativo' => 3, 'Email' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuario' => 1, 'senha' => 2, 'ativo' => 3, 'email' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USUARIO => 1, self::SENHA => 2, self::ATIVO => 3, self::EMAIL => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO' => 1, 'SENHA' => 2, 'ATIVO' => 3, 'EMAIL' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario' => 1, 'senha' => 2, 'ativo' => 3, 'email' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AdminPeer::USUARIO);
			$criteria->addSelectColumn(AdminPeer::SENHA);
			$criteria->addSelectColumn(AdminPeer::ATIVO);
