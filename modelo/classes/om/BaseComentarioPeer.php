...
abstract class BaseComentarioPeer {
	...
	/** the column name for the TICKET field */
	const TICKET = 'comentario.TICKET';

	/** the column name for the ORIGEM field */
	const ORIGEM = 'comentario.ORIGEM';

	/** the column name for the DATA_HORA field */
	const DATA_HORA = 'comentario.DATA_HORA';

	/** the column name for the COMENTARIO field */
	const COMENTARIO = 'comentario.COMENTARIO';

	/** the column name for the ATUALIZACAO field */
	const ATUALIZACAO = 'comentario.ATUALIZACAO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TicketId', 'Origem', 'DataHora', 'Comentario', 'Atualizacao', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'ticketId', 'origem', 'dataHora', 'comentario', 'atualizacao', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TICKET, self::ORIGEM, self::DATA_HORA, self::COMENTARIO, self::ATUALIZACAO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TICKET', 'ORIGEM', 'DATA_HORA', 'COMENTARIO', 'ATUALIZACAO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'ticket', 'origem', 'data_hora', 'comentario', 'atualizacao', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TicketId' => 1, 'Origem' => 2, 'DataHora' => 3, 'Comentario' => 4, 'Atualizacao' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'ticketId' => 1, 'origem' => 2, 'dataHora' => 3, 'comentario' => 4, 'atualizacao' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TICKET => 1, self::ORIGEM => 2, self::DATA_HORA => 3, self::COMENTARIO => 4, self::ATUALIZACAO => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TICKET' => 1, 'ORIGEM' => 2, 'DATA_HORA' => 3, 'COMENTARIO' => 4, 'ATUALIZACAO' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'ticket' => 1, 'origem' => 2, 'data_hora' => 3, 'comentario' => 4, 'atualizacao' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ComentarioPeer::TICKET);
			$criteria->addSelectColumn(ComentarioPeer::ORIGEM);
			$criteria->addSelectColumn(ComentarioPeer::DATA_HORA);
			$criteria->addSelectColumn(ComentarioPeer::COMENTARIO);
			$criteria->addSelectColumn(ComentarioPeer::ATUALIZACAO);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.TICKET');
			$criteria->addSelectColumn($alias . '.ORIGEM');
			$criteria->addSelectColumn($alias . '.DATA_HORA');
			$criteria->addSelectColumn($alias . '.COMENTARIO');
			$criteria->addSelectColumn($alias . '.ATUALIZACAO');
		}
	}
	...
	{
		// Invalidate objects in ImagemPeer instance pool,
	...
	public static function doCountJoinTicket(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::TICKET, TicketPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their Ticket objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinTicket(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (Ticket)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (Ticket)
				$obj2->addComentario($obj1);
