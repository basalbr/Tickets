...
abstract class BaseEmailPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TicketId', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'ticketId', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TICKET, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TICKET', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'ticket', 'email', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TicketId' => 1, 'Email' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'ticketId' => 1, 'email' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TICKET => 1, self::EMAIL => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TICKET' => 1, 'EMAIL' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'ticket' => 1, 'email' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(EmailPeer::TICKET);
	...
	public static function doCountJoinTicket(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EmailPeer::TICKET, TicketPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Email objects pre-filled with their Ticket objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinTicket(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to $obj2 (Ticket)
				$obj2->addEmail($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to the collection in $obj2 (Ticket)
				$obj2->addEmail($obj1);
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(EmailPeer::ID) && $criteria->keyContainsValue(EmailPeer::ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(EmailPeer::ID);
			if ($value) {
				$selectCriteria->add(EmailPeer::ID, $value, $comparison);
			} else {
