...
abstract class BaseEmail extends BaseObject  implements Persistent
{
	...
	public function setTicketId($v)
	{
		...
		if ($this->ticket !== $v) {
			$this->ticket = $v;
			$this->modifiedColumns[] = EmailPeer::TICKET;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = EmailPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(EmailPeer::TICKET)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmailPeer::TICKET)) $criteria->add(EmailPeer::TICKET, $this->ticket);
