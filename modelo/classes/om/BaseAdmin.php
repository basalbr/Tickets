...
abstract class BaseAdmin extends BaseObject  implements Persistent
{
	...
	public function setUsuario($v)
	{
		...
		if ($this->usuario !== $v) {
			$this->usuario = $v;
			$this->modifiedColumns[] = AdminPeer::USUARIO;
		}
	...
	public function setSenha($v)
	{
		...
		if ($this->senha !== $v) {
			$this->senha = $v;
			$this->modifiedColumns[] = AdminPeer::SENHA;
		}
	...
	public function setAtivo($v)
	{
		...
		if ($this->ativo !== $v) {
			$this->ativo = $v;
			$this->modifiedColumns[] = AdminPeer::ATIVO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ativo = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AdminPeer::USUARIO)) {
			$modifiedColumns[':p' . $index++]  = '`USUARIO`';
		}
		if ($this->isColumnModified(AdminPeer::SENHA)) {
			$modifiedColumns[':p' . $index++]  = '`SENHA`';
		}
		if ($this->isColumnModified(AdminPeer::ATIVO)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdminPeer::USUARIO)) $criteria->add(AdminPeer::USUARIO, $this->usuario);
		if ($this->isColumnModified(AdminPeer::SENHA)) $criteria->add(AdminPeer::SENHA, $this->senha);
		if ($this->isColumnModified(AdminPeer::ATIVO)) $criteria->add(AdminPeer::ATIVO, $this->ativo);
